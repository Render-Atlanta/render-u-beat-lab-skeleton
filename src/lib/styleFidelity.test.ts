...
describe("extractRhythmFeatures", () => {
  ...
  it("returns zero shares for an empty pattern without NaN", () => {
    const empty = { kick: [], snare: [], hat: [], openHat: [], clap: [], "808": [], bassGuitar: [], melody: [] } as unknown as typeof BEAT_STYLES.trap.pattern;
    const f = extractRhythmFeatures(
      { kick: new Array(16).fill(false), snare: new Array(16).fill(false), hat: new Array(16).fill(false), openHat: new Array(16).fill(false), clap: new Array(16).fill(false), "808": new Array(16).fill(false), bassGuitar: new Array(16).fill(false), melody: new Array(16).fill(false) },
